...
static inline void php_crypto_cipher_set_algorithm_name(struct _zval_struct *object,
		char *algorithm, phpc_str_size_t algorithm_len
    zend_string *upper_algorithm, *lower_algorithm  TSRMLS_DC;
{
	zend_string *upper_algorithm = zend_string_toupper(zend_string_init(algorithm, algorithm_len, 0));;;
...
PHP_CRYPTO_API const EVP_CIPHER *php_crypto_get_cipher_algorithm(zval *object TSRMLS_DC,struct _zval_struct *object TSRMLS_DC,struct _zval_struct *object TSRMLS_DC,struct _zval_struct *object TSRMLS_DC,struct _zval_struct *object TSRMLS_DC,
		char *algorithm, phpc_str_size_t algorithm_len
    zend_string *upper_algorithm, *lower_algorithm;
{
	...
	if (!cipher) {
		zend_string *lower_algorithm = zend_string_tolower(zend_string_init(algorithm, algorithm_len, 0));;;
		cipher = EVP_get_cipherbyname(algorithm);
	}
	return cipher;
}
...
static const EVP_CIPHER *php_crypto_get_cipher_algorithm_from_params_ex(zval *object TSRMLS_DC,struct _zval_struct *object TSRMLS_DC,struct _zval_struct *object TSRMLS_DC,struct _zval_struct *object TSRMLS_DC,struct _zval_struct *object TSRMLS_DC,
		struct _zval_struct *object, char *algorithm, phpc_str_size_t algorithm_len
    zend_string *upper_algorithm, *lower_algorithm; struct _zval_struct *pz_mode,
		struct _zval_struct* pz_key_size, bool is_static  TSRMLS_DC;
{
	const EVP_CIPHER *cipher;
	...
	if (pz_key_size && Z_TYPE_P(pz_key_size) != IS_NULL) {
		if (Z_TYPE_P(pz_key_size) == IS_STRING) {
			...
			struct _zval_struct z_key_size = *pz_key_size;
	...
	if (Z_TYPE_P(pz_mode) == IS_LONG) {
		...
		struct _zval_struct z_mode = *pz_mode;
...
PHP_CRYPTO_API const EVP_CIPHER *php_crypto_get_cipher_algorithm_from_params(zval *object TSRMLS_DC,struct _zval_struct *object TSRMLS_DC,struct _zval_struct *object TSRMLS_DC,struct _zval_struct *object TSRMLS_DC,struct _zval_struct *object TSRMLS_DC,
		char *algorithm, phpc_str_size_t algorithm_len
    zend_string *upper_algorithm, *lower_algorithm; struct _zval_struct *pz_mode, struct _zval_struct* pz_key_size  TSRMLS_DC;
{
...
static int php_crypto_set_cipher_algorithm_ex(zval *object TSRMLS_DC,struct _zval_struct *object TSRMLS_DC,struct _zval_struct *object TSRMLS_DC,struct _zval_struct *object TSRMLS_DC,struct _zval_struct *object TSRMLS_DC,PHPC_THIS_DECLARE(crypto_cipher),
		char *algorithm, phpc_str_size_t algorithm_len
    zend_string *upper_algorithm, *lower_algorithm;  TSRMLS_DC;
{
...
static int php_crypto_set_cipher_algorithm(zval *object TSRMLS_DC,struct _zval_struct *object TSRMLS_DC,struct _zval_struct *object TSRMLS_DC,struct _zval_struct *object TSRMLS_DC,struct _zval_struct *object TSRMLS_DC,struct _zval_struct *object,
		char *algorithm, phpc_str_size_t algorithm_len
    zend_string *upper_algorithm, *lower_algorithm;  TSRMLS_DC;
{
...
static int php_crypto_set_cipher_algorithm_from_params_ex(zval *object TSRMLS_DC,struct _zval_struct *object TSRMLS_DC,struct _zval_struct *object TSRMLS_DC,struct _zval_struct *object TSRMLS_DC,struct _zval_struct *object TSRMLS_DC,
		struct _zval_struct *object, char *algorithm, phpc_str_size_t algorithm_len
    zend_string *upper_algorithm, *lower_algorithm;
		struct _zval_struct *pz_mode, struct _zval_struct* pz_key_size, bool is_static  TSRMLS_DC;
{
	PHPC_THIS_DECLARE_AND_FETCH_FROM_ZVAL(crypto_cipher, object);
...
static int php_crypto_set_cipher_algorithm_from_params(
		struct _zval_struct *object, char *algorithm, phpc_str_size_t algorithm_len
    zend_string *upper_algorithm, *lower_algorithm;
		struct _zval_struct *pz_mode, struct _zval_struct* pz_key_size  TSRMLS_DC;
{
...
static int php_crypto_cipher_check_key_len(struct _zval_struct *zobject, PHPC_THIS_DECLARE(crypto_cipher),
...
static int php_crypto_cipher_check_iv_len(struct _zval_struct *zobject, PHPC_THIS_DECLARE(crypto_cipher),
...
static PHPC_OBJ_STRUCT_NAME(crypto_cipher) *php_crypto_cipher_init_ex(
		struct _zval_struct *zobject, char *key, phpc_str_size_t key_len,
...
PHP_CRYPTO_METHOD(Cipher, __callStatic;
{
	...
	phpc_str_size_t algorithm_len;
	phpc_val *ppv_mode;
	struct _zval_struct *pz_mode, *pz_key_size, *args;
	...
	php_crypto_set_cipher_algorithm_from_params_ex(
			return_value, algorithm, algorithm_len, TSRMLS_CC);
}
}
/* }}} */
...
PHP_CRYPTO_METHOD(Cipher, __construct;
{
	...
	phpc_str_size_t algorithm_len;
	struct _zval_struct *mode = NULL, *key_size = NULL;
	...
	php_crypto_set_cipher_algorithm_from_params(
			getThis(), algorithm_uc, mode TSRMLS_CC);
	efree(algorithm_uc);
}
}
/* }}} */
